        ...
        <div style={{ padding: '0 16px 16px' }}>
          <div style={{ display: 'grid', gap: '10px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              {existing && (
                <button onClick={() => { if (window.confirm(`Remove the ${platform} integration?`)) deleteMutation.mutate(); }} disabled={deleteMutation.isPending} style={{ flex: 1, padding: '8px', borderRadius: '6px', border: '1px solid rgba(255,77,79,0.3)', background: 'transparent', color: 'var(--error)', fontSize: '12px', cursor: 'pointer' }}>
