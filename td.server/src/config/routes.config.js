...
const routes = (router) => {
    ...
    router.get('/api/roles', requirePermission('roles:manage'), rolesController.listRoles);
    router.get('/api/permissions', requirePermission('roles:manage'), rolesController.listPermissionCatalog);
    router.post('/api/roles', requirePermission('roles:manage'), auditMiddleware('ROLE_CREATE'), rolesController.createRole);
    router.put('/api/roles/:id', requirePermission('roles:manage'), auditMiddleware('ROLE_UPDATE'), rolesController.updateRole);
    router.delete('/api/roles/:id', requirePermission('roles:manage'), auditMiddleware('ROLE_DELETE'), rolesController.deleteRole);
